...
import com.mycompany.myapp.service.JhipsterKafkaConsumer;
...
public class JhipsterKafkaResourceIT {
    ...
    @Autowired
    private JhipsterKafkaProducer producer;

    @Autowired
    private JhipsterKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        JhipsterKafkaResource kafkaResource = new JhipsterKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/jhipster-kafka/publish?message=test"))
